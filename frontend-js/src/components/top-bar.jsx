    ...
    <header className="bg-card border-b border-border sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link to="/" className="font-heading text-2xl font-bold text-primary flex-shrink-0">
            Store
          </Link>
          ...
          <div className="hidden md:flex flex-1 max-w-2xl mx-8 relative">
            <form onSubmit={handleSearchSubmit} className="w-full">
              <div className="relative">
                ...
                <Input
                  type="text"
                  placeholder="Searching is Unavailable Currently Please Select Category "
                  value={searchQuery}
          ...
          <div className="hidden md:flex items-center gap-4">
            {/* Cart */}
            <Link to="/cart" aria-label={`Shopping cart with ${cartItemCount} items`}>
